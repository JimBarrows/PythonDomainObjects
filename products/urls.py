...
urlpatterns = patterns('products.views',
	...
	(r'^pricing/one_time_charges$', login_required(OneTimeChargeList.as_view( ))),
	(r'^pricing/one_time_charges/add$', login_required(OneTimeChargeCreate.as_view( ))),
	(r'^pricing/one_time_charges/(?P<pk>\d+)/$', login_required(OneTimeChargeDetail.as_view( ))),
	(r'^pricing/one_time_charges/update/(?P<pk>\d+)/$', login_required(OneTimeChargeUpdate.as_view( ))),
	(r'^pricing/one_time_charges/delete/(?P<pk>\d+)/$', login_required(OneTimeChargeDelete.as_view( ))),
